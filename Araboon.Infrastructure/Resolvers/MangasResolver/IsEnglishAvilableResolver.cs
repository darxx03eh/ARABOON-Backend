...
{
    public class IsEnglishAvilableResolver : IValueResolver<Manga, GetMangaByIDResponse, bool>
    {
        private readonly IUnitOfWork unitOfWork;

        public IsEnglishAvilableResolver(IUnitOfWork unitOfWork) => this.unitOfWork = unitOfWork;
        public bool Resolve(Manga source, GetMangaByIDResponse destination, bool destMember, ResolutionContext context)
        {
            ...
            return  Convert.ToBoolean(source.EnglishAvilable) || isAdmin;
        }
    }
}
