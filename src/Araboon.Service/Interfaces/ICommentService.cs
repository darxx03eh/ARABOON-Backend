...
namespace Araboon.Service.Interfaces
{
    ...
    {
        public Task<(string, GetMangaCommentsResponse?)> AddCommentAsync(string content, int mangaId);
        public Task<string> DeleteCommentAsync(int id);
        public Task<(string, string?, string?)> UpdateCommentAsync(string content, int id);
