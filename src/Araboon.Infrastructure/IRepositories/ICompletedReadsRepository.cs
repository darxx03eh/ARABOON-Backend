...
namespace Araboon.Infrastructure.IRepositories
{
    ...
    {
        public Task<(string, PaginatedResult<GetPaginatedCompletedReadsMangaResponse>?)> GetPaginatedCompletedReadsMangaAsync(int pageNumber, int pageSize, bool isAdmin);
