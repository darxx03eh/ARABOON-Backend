...
namespace Araboon.API.Controllers
{
    ...
    public class CurrentlyReadingsController : AppBaseController
    {
        ...
        public async Task<IActionResult> ViewCurrentlyReadingManga(int pageNumber = 1)
        {
        ...
        public async Task<IActionResult> AddToCurrentlyReading(int id)
        {
        ...
        public async Task<IActionResult> RemoveFromCurrentlyReading(int id)
        {
